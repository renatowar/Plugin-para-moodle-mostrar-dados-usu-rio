...
$string['extradescription'] = 'Format: <b>shortname</b> (String), <b>display_name</b> (String), <b>hide</b> (true or false), <b>[color]</b> (Hexadecimal);<br>Example: <br><code>phonenumber, Phone Number, true; <br>cityuser, City, false; </code>';
$string['extrafieldsexceptions1'] = "Too many fields found on line: ";
$string['extrafieldsexceptions2'] = " , on line: ";
$string['extrafieldsexceptions3'] = "Invalid hexadecimal color format: ";
$string['extrafieldsexceptions4'] = "Invalid format for the 'hide' field: ";
$string['extrafieldsexceptions5'] = "Empty field(s) found on line: ";
$string['extrafieldsexceptions6'] = "Please check if ',' and ';' are being used correctly.";
$string['extrafieldsexceptions7'] = "Custom field not found: ";